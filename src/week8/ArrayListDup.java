...
public class ArrayListDup {
    public static void main(String[] args) {
        ...
        while (keepPlaying.equalsIgnoreCase("y")) {
            ...
            System.out.println(dups(numList));
    ...
    public static ArrayList<Integer> dups(ArrayList<Integer> numbersList) {
        ...
        for (Integer i : numbersList) {
            if (!uniqueNumbers.contains(i)) {
                uniqueNumbers.add(i);
            } else if (uniqueNumbers.contains(i) && !duplicateNumbers.contains(i)) {
